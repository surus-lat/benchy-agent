/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9225372c9c7033e0ea14637bdddbc9eb)
// Runtime types generated with workerd@1.20260917.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	BETTER_AUTH_URL: "https://getbenchy.lat";
	EMAIL_FROM: "auth@getbenchy.lat";
	OWNER_NOTIFY_EMAIL: "francis@surus.lat";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "EMAIL_FROM" | "OWNER_NOTIFY_EMAIL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
