/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cbd435943b7e7c8753e13dde70c8e4dd)
// Runtime types generated with workerd@1.20260917.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	BETTER_AUTH_URL: "https://benchy-agent.pages.dev";
	EMAIL_FROM: "auth@benchy.example";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "EMAIL_FROM" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
